...
let init = (app) => {
        ...
        axios.post(add_job_url,
            {
                ...
                notes: app.vue.notes,
                _state: {company: "clean", title: "clean", URL: "clean", description: "clean", referral: "clean", salary: "clean", type: cleantype, location: "clean", status: "clean", date_applied: "clean", notes: "clean"},
    ...
    app.init = () => {
        ...
        axios.get(load_job_url).then(function (response) {
